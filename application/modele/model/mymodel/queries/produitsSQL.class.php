...
class ProduitsSQL extends Query
{
    ...
    public function findProductByCategorie($categorie){
        $sql = "
SELECT produits.id as pid,titre, description,prix,visible,nouveaute,nb_ventes,stock,id_categorie,nom,categorie.id as cid, image.id as iid,url,img_main,id_produit FROM produits 
